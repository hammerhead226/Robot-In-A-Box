...
public class CoralScoringRollerIOTalonFX implements CoralScoringRollerIO {
  ...
  public CoralScoringRollerIOTalonFX() {
  ...
  @Override
  public void updateInputs(CoralScoringRollerIOInputs inputs) {
