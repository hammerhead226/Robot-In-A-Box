...
public class CoralIntakeRoller extends SubsystemBase {
  private final CoralIntakeRollerIO io;
  ...
  private final CoralIntakeRollerIOInputsAutoLogged inputs = new CoralIntakeRollerIOInputsAutoLogged();
  private final SimpleMotorFeedforward ffModel;
  private final SysIdRoutine sysId;

  /** Creates a new Flywheel. */
  public CoralIntakeRoller(CoralIntakeRollerIO io, SensorIO sensor) {
    this.io = io;
    this.sensor = sensor;
