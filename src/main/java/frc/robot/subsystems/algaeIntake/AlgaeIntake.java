...
public class AlgaeIntake extends SubsystemBase {
  private final AlgaeIntakePivotIO arm;
  
  private final AlgaeIntakeIOInputsAutoLogged pInputs = new AlgaeIntakeIOInputsAutoLogged();
  ...
  /** Creates a new Arm. */
  public AlgaeIntake(AlgaeIntakePivotIO arm, SensorIO sensor) {
    this.arm = arm;
