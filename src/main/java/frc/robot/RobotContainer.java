...
public class RobotContainer {
    ...
    public RobotContainer() {
        switch (SimConstants.currentMode) {
            case REAL:
                ...
                // CoralState.DEFAULT,
                // AlgaeState.DEFAULT);
                scoralRollers = new ScoralRollers(
                ...
                superStructure = new SuperStructure(drive, elevator, scoralArm, scoralRollers, led, climberArm, winch);
        ...
        reefAlignTrigger = new Trigger(
                () -> driveController.leftTrigger().getAsBoolean()
                        || driveController.rightTrigger().getAsBoolean());
        approachPerpendicularTrigger = new Trigger(
  ...
  /
    ...
    public SuperStructure getSuperStr
        return superStruc
    }
    ...
    public ScoralRollers getScoralR
        return scoralRol
    }
