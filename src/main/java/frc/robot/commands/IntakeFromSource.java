...
public class IntakeFromSource extends Command {
  ...
  public void initialize() {
    ...
    arm.setPositionDegs(CoralScorerArmConstants.INTAKE_SETPOINT_DEG, CoralScorerArmConstants.ARM_VELOCITY_DEGPERSEC);
  ...
  public void end(boolean interrupted) {
    ...
    arm.setPositionDegs(CoralScorerArmConstants.STOW_SETPOINT_DEG, CoralScorerArmConstants.ARM_VELOCITY_DEGPERSEC);
