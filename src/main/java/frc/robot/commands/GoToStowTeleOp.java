...
public class GoToStowTeleOp extends SequentialCommandGroup {
  private final Elevator elevator;

  private final ScoralArm scoralArm;
  private final ScoralRollers scoralRollers;
  /** Creates a new GoToStowL4. */
  public GoToStowTeleOp(Elevator m_elevator, ScoralArm m_scoralArm, ScoralRollers m_scoralRollers) {
